...
# if os.path.isfile(f"/nfs/a319/gy17m2a/MetricEvaluation/DanishRainData_Outputs/{temp_res}mins/All_events_{file_name}"):
#     print(f"{file_name} is already a file")
# else:
#     print(f"{file_name} is not already a file")

#     with open(f'/nfs/a319/gy17m2a/MetricEvaluation/DanishRainDataPickles/{file_name}.pkl', 'rb') as f:
...
#         # Get the timeseries
#         ts = precip_time_series(f"/nfs/a319/gy17m2a/MetricEvaluation/{directory}/{file_name}", temp_res)
...
#             all_events_df.to_csv(f"/nfs/a319/gy17m2a/MetricEvaluation/DanishRainData_Outputs/{temp_res}mins/All_events_{file_name}", index=False)
#     else:
#         print("its empty")
